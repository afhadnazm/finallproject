...
<body class="bg-gray-100"  style="font-family: Cambria, Georgia, serif">
    ...
    <section id="home" class="bg-[url('{{ asset('storage/images/nursing.jpg') }}')] bg-cover  bg-no-repeat py-52">
        ...
        <div class="container mx-auto text-center px-4 pt-20">
            <h1 class="text-5xl md:text-6xl font-bold text-white fade-in">College of Nursing</h1>
    ...
    <section id="about" class="py-16 bg-white">
        <div class="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center px-4">
            <div>
                <h2 class="text-3xl font-semibold text-gray-700 mb-4 slide-in-left">Welcome to the College of Nursing</h2>
                <p class="text-gray-600 leading-relaxed slide-in-left delay-100">
                    The College of Nursing is committed to excellence in nursing education, research, and practice.
                    Our programs prepare compassionate, skilled nurses who provide high-quality care and leadership
                    in diverse healthcare settings across the lifespan.
                </p>
                <p class="text-gray-600 mt-4 leading-relaxed slide-in-left delay-200">
                    Founded in 1968, our college has a rich history of nursing education excellence. We are
                    accredited by the Commission on Collegiate Nursing Education (CCNE) and consistently rank
                    among the top nursing schools nationally for education quality and research.
                </p>
                <p class="text-gray-600 mt-4 leading-relaxed slide-in-left delay-300">
                    Our mission is to develop nurse leaders who advance health, transform care delivery, and
                    promote wellness through innovative education, research, and clinical practice. We foster
                    a supportive environment where students develop the knowledge, skills, and compassion needed
                    to excel in today's complex healthcare landscape.
                </p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center gap-8 md:gap-12 lg:gap-16">
                ...
                <div class="text-center mb-8 fade-in delay-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800">Dr.  Vian Afan Naqshbandi</h3>
                    <p class="text-orange-500">Dean,Professor of Nursing</p>
                </div>
                ...
                <!-- Faculty Member 2 -->
                   <div class="text-center mb-8 fade-in delay-100">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800">Dr.  Suha Hussein Ahmed</h3>
                    <p class="text-orange-500">Dean,Professor of Nursing</p>
                </div>
                <!-- Faculty Member 3 -->
                <div class="text-center mb-8 fade-in delay-300">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800">Dr.  Tiran Jamil Piro</h3>
                    <p class="text-orange-500">Assistant Professor of Nursing</p>
                </div>
                ...
                <div class="text-center mb-8 fade-in delay-400">
                    ...
                    <h3 class="text-xl font-semibold text-gray-800">Dr.  Yousif Bakr Omar</h3>
