...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-2xl bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <!-- Form -->
        <form class="p-8" method="POST" action="/register" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="space-y-6">
                        ...
                        <div class="mt-1 flex items-center">
                            <label for="student_id" class="cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition">
                                    ...
                                    <input id="student_id" name="student_id" type="file" accept="image/*,.pdf" class="hidden" required>
                                </div>
                            </label>
                        </div>
                    </div>
                            ...
                            <label for="enrollment_proof" class="cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">JPEG, PNG, or PDF (Max 5MB)</p>
                                        <div id="enrollment-proof-filename" class="text-blue-600 text-sm mt-2 hidden"></div>
                                    </div>
                                    <input id="enrollment_proof" name="enrollment_proof" type="file" accept="image/*,.pdf" class="hidden" required>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- Additional Notes -->
                    <div>
                        <label for="verification_notes" class="block text-gray-700 text-sm font-medium mb-2">Additional Verification Notes</label>
            ...
            <div class="mb-6 flex items-start">
                ...
                <label for="terms" class="ml-2 block text-sm text-gray-700">
                    I certify that all information provided is accurate and I agree to the <a href="#" class="text-blue-600 hover:underline">Terms of Service</a> and <a href="#" class="text-blue-600 hover:underline">Privacy Policy</a>
                </label>
            </div>
            ...
            <div class="mt-6 text-center text-sm text-gray-600">
                Already have an account? <a href="{{route('student.login')}}" class="text-red-600 font-medium hover:underline">Sign in</a>
            </div>
        </form>
    </div>
