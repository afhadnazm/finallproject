...
<body class="bg-gray-100" style="font-family: Cambria, Georgia, serif">
                ...
                <div class="hidden md:flex space-x-6 text-xl font-bold relative mx-auto">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute mt-2 hidden group-hover:block bg-white shadow-md rounded-lg p-4 pr-12 left-0">
                            ...
                            <a href="contact.html" class="block py-2 text-gray-600 hover:text-red-600 whitespace-nowrap">Contact us</a>
    ...
    <section data-aos="fade-down-left" class="mt-10">
        ...
        <div class="grid grid-cols-2 items-center justify-between px-20 p-4 pb-20 space space-x-6">
            ...
            <div>
                <h1 class="text-red-600 text-3xl pb-6 font-semibold "><SPAN class="text-black">HAWLER </SPAN> MEDICAL UNIVERSITY</h1>
                <p class="text-justify text-gray-500">Hawler Medical University is public institution of undergraduate and postgraduate higher education and research in different medical sciences disciplines. <br><br>

                    Hawler Medical University is located in the city of Erbil (Hawler) in Iraqi Kurdistan Region. Hawler Medical University has been established by the Council of Ministers of the Iraqi Kurdistan Regional Government in July 2005 and endorsed by the Council of Ministers of Iraqi Federal Government in March 2006. The university has been established to include in itself the five colleges that were belonging to Salahaddin University in Erbil (except College of Health Sciences). The colleges are: College of Medicine, College of Dentistry, College of Pharmacy, College of Nursing and College of Health Sciences. <br><br>
                    
                    The separation has come after a suggestion made by a number of academics from these colleges supported by the presidency of Salahaddin University as well as the Ministry of Health and the Ministry of Higher Education and Scientific Researches.</p>
            ...
            <ul class="space-y-4">
              ...
              <li>
                <a href="#" class="text-gray-800 font-medium hover:text-red-600">
                    The president of the Union of International Universities presented a membership certificate to the president of Hawler M...
                </a>
        ...
        <div class="container mx-auto p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div class="border rounded-lg shadow-md p-4">
                ...
                <p class="text-gray-700 text-sm mb-3">
                    EDJ is a peer-review, open-access journal, which is published two times per year. EDJ aims to publish peer-reviewed manuscripts of Iraqi, regional, and international interests.
                </p>
                <a href="#" class="text-red-500 font-semibold">Read the Abstract ➜</a>
              </div>
              ...
              <div class="border rounded-lg shadow-md p-4">
                ...
                <p class="text-gray-700 text-sm mb-3">
                  Till now, the Ministry of Higher Education and Scientific Research in Kurdistan Region is not connected to the network because there isn't…
                </p><br>
                <a href="#" class="text-red-500 font-semibold">Read the Abstract ➜</a>
              </div>
