...
<body class="bg-gray-100 font-serif max-w-[100vw] overflow-x-hidden">
  ...
  <!-- Navbar -->
  <nav class="bg-white backdrop-blur-md shadow-sm fixed top-0 left-0 w-full z-40 p-6">
    <div class="container mx-auto px-4">
      <div class="flex justify-between items-center h-16">
        <!-- Logo -->
        <div class="flex items-center">
          <img src="{{ asset('storage/images/logo.jpg') }}" alt="Logo" class="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 rounded-md">
          <span class="ml-2 text-sm sm:text-base md:text-lg font-semibold text-orange-600">Hawler Medical University</span>
        </div>
        ...
        <div class="hidden lg:flex space-x-1">
          ...
          <div class="relative group">
            <a href="/" class="px-2 py-2 text-gray-700 flex items-center hover:text-orange-600 transition-colors duration-200">
              HOME
          ...
          <a href="{{ url('/events') }}" class="px-2 py-2 text-gray-700 hover:text-orange-600 transition-colors duration-200">EVENTS</a>
      ...
      <div id="mobile-menu" class="hidden lg:hidden bg-white shadow-lg rounded-b-lg overflow-hidden">
        <div class="px-4 py-2 space-y-1">
          ...
          <div class="mobile-accordion">
            <button class="flex justify-between items-center w-full py-2 text-gray-700 hover:text-orange-600">
              <span>HOME</span>
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="/" class="block py-1 text-gray-600 hover:text-orange-600">Home</a>
              <a href="{{ url('/aboutus') }}" class="block py-1 text-gray-600 hover:text-orange-600">About Us</a>
              <a href="{{ url('/contactus') }}" class="block py-1 text-gray-600 hover:text-orange-600">Contact Us</a>
            </div>
          </div>
          ...
          <div class="mobile-accordion">
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="{{ url('/universitycounsel') }}" class="block py-1 text-gray-600 hover:text-orange-600">University Council</a>
              <a href="{{ url('/presidentoffice') }}" class="block py-1 text-gray-600 hover:text-orange-600">President's Office</a>
              <a href="{{ url('/vission') }}" class="block py-1 text-gray-600 hover:text-orange-600">Vision and Mission</a>
              <a href="{{ url('/logo') }}" class="block py-1 text-gray-600 hover:text-orange-600">University Logo</a>
            </div>
          </div>
          ...
          <div class="mobile-accordion">
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="{{ route('colleges.medicine') }}" class="block py-1 text-gray-600 hover:text-orange-600">College of Medicine</a>
              <a href="{{ route('colleges.dentistry') }}" class="block py-1 text-gray-600 hover:text-orange-600">College of Dentistry</a>
              <a href="{{ route('colleges.pharmacy') }}" class="block py-1 text-gray-600 hover:text-orange-600">College of Pharmacy</a>
              <a href="{{ route('colleges.nursing') }}" class="block py-1 text-gray-600 hover:text-orange-600">College of Nursing</a>
            </div>
          </div>
          ...
          <div class="mobile-accordion">
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="{{ url('/library') }}" class="block py-1 text-gray-600 hover:text-orange-600">Library</a>
              <a href="{{ url('/confrance') }}" class="block py-1 text-gray-600 hover:text-orange-600">Conferences</a>
              <a href="{{ url('/relevantwebs') }}" class="block py-1 text-gray-600 hover:text-orange-600">Relevant Websites</a>
              <a href="{{ url('/acadimicrelations') }}" class="block py-1 text-gray-600 hover:text-orange-600">Academic Relations</a>
              <a href="{{ url('/acadimicprofile') }}" class="block py-1 text-gray-600 hover:text-orange-600">Academicians Profile</a>
            </div>
          </div>
          ...
          <div class="mobile-accordion">
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="{{ url('/it-service') }}" class="block py-1 text-gray-600 hover:text-orange-600">IT Services</a>
              <a href="{{ url('/documents') }}" class="block py-1 text-gray-600 hover:text-orange-600">Documents</a>
              <a href="{{ url('/e-management') }}" class="block py-1 text-gray-600 hover:text-orange-600">E-Management</a>
            </div>
          </div>

          <a href="{{ url('/events') }}" class="block py-2 text-gray-700 hover:text-orange-600">EVENTS</a>
          ...
          <div class="mobile-accordion">
            ...
            <div class="hidden px-4 py-2 bg-gray-50 rounded-lg">
              <a href="/student_login" class="block py-1 text-gray-600 hover:text-orange-600">Student Portal</a>
              <a href="/teacher_login" class="block py-1 text-gray-600 hover:text-orange-600">Teacher Portal</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="relative w-full pt-16">
    ...
    <div class="w-full overflow-hidden">
      <img src="{{asset('storage/images/citadel.jpg')}}" alt="Hero Image" class="w-full h-[50vh] md:h-[60vh] lg:h-[70vh] object-cover">
      <!-- Dark Overlay -->
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center text-white mt-16 px-4">
      <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 text-center opacity-0 animate-slideInUp shadow-lg">Hawler Medical University</h1>
      <p class="text-base sm:text-lg md:text-xl text-center max-w-4xl opacity-0 animate-slideInUp" style="animation-delay: 0.2s;">We provide you with our best scientific experience and professionals for our academics and students to achieve an optimal learning outcome.</p>
    </div>
  </div>
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div data-aos="fade-right" data-aos-delay="100" class="order-2 md:order-1">
          <h1 class="text-2xl sm:text-3xl pb-4 font-semibold bg-gradient-to-r from-orange-600 to-orange-800 bg-clip-text text-transparent"><span class="text-black">HAWLER </span> MEDICAL UNIVERSITY</h1>
  ...
  <section class="bg-gray-50 py-12 md:py-20">
    <div class="container mx-auto px-4">
      <div class="mb-8">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 bg-gradient-to-r from-gray-800 to-gray-800 bg-clip-text">LATEST <span class="text-orange-500">NEWS</span></h2>
        <p class="text-gray-600 mt-2">Stay updated with our university</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="flex flex-col sm:flex-row bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl" data-aos="fade-up" data-aos-delay="100">
            <img src="{{asset('storage/images/news1.jpg')}}" alt="News Image" class="w-full sm:w-1/3 h-48 sm:h-auto object-cover">
          ...
          <div class="flex flex-col sm:flex-row bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl" data-aos="fade-up" data-aos-delay="200">
            <img src="{{asset('storage/images/news2.jpg')}}"  data-aos-delay="200">
            <img src="{{asset('storage/images/news2.jpg')}}" alt="News Image" class="w-full sm:w-1/3 h-48 sm:h-auto object-cover">
            <div class="p-4 w-full sm:w-2/3">
              <div class="flex items-center text-orange-600 font-semibold text-lg">
                <span class="bg-gray-200 p-2 rounded-full mr-2">20</span>
                <span>NOV</span>
        ...
        <!-- Sidebar Column -->
        <div class="bg-white rounded-lg shadow-lg p-4 transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl" data-aos="fade-up" data-aos-delay="300">
          ...
          <ul class="space-y-4">
            ...
            <li class="transform transition-all duration-300 hover:translate-x-1">
              <a href="#" class="text-gray-800 font-medium hover:text-orange-600 transition-colors">
          ...
          <button class="mt-6 w-full bg-orange-600 text-white font-semibold py-2 rounded hover:bg-orange-700 transition-all">
            EVEN MORE
          </button>
        </div>
      </div>
  ...
  <section class="py-12 md:py-20">
    <div class="container mx-auto px-4">
      <div class="mb-8">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 bg-gradient-to-r from-gray-800 to-gray-800 bg-clip-text">FOR <span class="text-orange-500">RESEARCHERS</span></h2>
        <p class="text-gray-600 mt-2">Resources and opportunities for academic research</p>
      </div>
      
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Card 1 -->
        <div class="border rounded-lg shadow-md p-4 transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl hover:rotate-1" data-aos="fade-up" data-aos-delay="100">
        ...
        <!-- Card 2 -->
        <div class="border rounded-lg shadow-md p-4 transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl hover:rotate-1" data-aos="fade-up" data-aos-delay="200">
        ...
        <!-- Card 3 -->
        <div class="border rounded-lg shadow-md p-4 transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl hover:rotate-1" data-aos="fade-up" data-aos-delay="300">
        ...
        <!-- Card 4 -->
        <div class="border rounded-lg shadow-md p-4 transform transition-all duration-300 hover:translate-y-[-5px] hover:shadow-xl hover:rotate-1" data-aos="fade-up" data-aos-delay="400">
      ...
      <div class="text-center mt-8">
        <button class="bg-orange-500 text-white py-2 px-6 rounded-lg hover:bg-orange-600 transition-colors">
          More Research
        </button>
      </div>
    </div>
  ...
  <section class="bg-white py-12 md:py-20">
    <div class="container mx-auto px-4">
      <!-- Section Title -->
      <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-center bg-gradient-to-r from-orange-600 to-orange-800 bg-clip-text text-transparent mb-8">
        MEDIA
      </h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="text-center" data-aos="fade-right">
          <h3 class="text-xl sm:text-2xl font-semibold text-gray-800 underline underline-offset-4 mb-6">
            VIDEO GALLERY
          </h3>
          ...
          <button class="bg-orange-600 text-white px-6 py-2 rounded-md hover:bg-orange-800 transition-colors">
            MORE VIDEOS
          </button>
        </div>
        ...
        <div data-aos="fade-left">
          <h3 class="text-xl sm:text-2xl font-semibold text-center text-gray-800 underline underline-offset-4 mb-6">
            IMAGE GALLERY
          </h3>
          <!-- Image Grid -->
          <div class="grid grid-cols-2 gap-4 mb-6">
            <img src="{{asset('storage/images/news1.jpg')}}" alt="Gallery Image" class="rounded-md shadow-md transform transition-all duration-300 hover:scale-105 h-32 sm:h-40 w-full object-cover">
            <img src="{{asset('storage/images/news2.jpg')}}" alt="Gallery Image" class="rounded-md shadow-md transform transition-all duration-300 hover:scale-105 h-32 sm:h-40 w-full object-cover">
            <img src="{{asset('storage/images/news3.jpg')}}" alt="Gallery Image" class="rounded-md shadow-md transform transition-all duration-300 hover:scale-105 h-32 sm:h-40 w-full object-cover">
            <img src="{{asset('storage/images/news4.jpg')}}" alt="Gallery Image" class="rounded-md shadow-md transform transition-all duration-300 hover:scale-105 h-32 sm:h-40 w-full object-cover">
          </div>
  ...
  <footer class="bg-gray-900 text-gray-300 py-10">
    <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
      <!-- Contact HMU Section -->
      <div>
        <h3 class="text-lg font-semibold text-white mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Contact HMU</h3>
        <ul class="space-y-2">
          <li class="flex items-center transform transition-all duration-300 hover:translate-x-1">
          ...
          <li class="transform transition-all duration-300 hover:translate-x-1">Tel: +964 66 227 3384</li>
          <li class="transform transition-all duration-300 hover:translate-x-1">Fax: +964 66 227 3382</li>
      ...
      <div>
        <h3 class="text-lg font-semibold text-white mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Opening Hours</h3>
        <p class="transform transition-all duration-300 hover:translate-x-1">Sunday - Thursday: <span class="text-gray-100">08:30 am - 03:00 pm</span></p>
        <p class="transform transition-all duration-300 hover:translate-x-1">Friday and Saturday: <span class="bg-orange-500 text-white rounded px-2 py-1">Closed</span></p>
      </div>

      <!-- Web Traffic Section -->
      <div>
        <h3 class="text-lg font-semibold text-white mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">Web Traffic</h3>
        <ul class="space-y-1">
          <li class="transform transition-all duration-300 hover:translate-x-1">👤 Today: <span class="text-gray-100">2265</span></li>
          <li class="transform transition-all duration-300 hover:translate-x-1">👤 Yesterday: <span class="text-gray-100">3898</span></li>
          <li class="transform transition-all duration-300 hover:translate-x-1">👤 This Week: <span class="text-gray-100">12748</span></li>
          <li class="transform transition-all duration-300 hover:translate-x-1">👤 This Month: <span class="text-gray-100">90849</span></li>
          <li class="transform transition-all duration-300 hover:translate-x-1">👤 Total: <span class="text-gray-100">4394545</span></li>
        </ul>
      ...
      <!-- QR Code Section -->
      <div>
        <h3 class="text-lg font-semibold text-white mb-3 bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">QR Code</h3>
  ...
  <!-- Back to Top Button -->
  <button id="back-to-top" class="fixed bottom-6 right-6 bg-orange-500 text-white rounded-full p-3 shadow-lg hidden hover:bg-orange-600 transition duration-300 z-50">
