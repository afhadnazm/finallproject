...
<!-- Navbar --><nav class="bg-white shadow-sm fixed top-0 left-0 w-full z-10 animate-fade-in p-6">
...
<div class="mb-6">
  <!-- Title -->
  <h1 class="text-5xl font-bold text-gray-900 mb-4">Academic Relations</h1>
  ...
  <div class="flex items-start space-x-4">
    ...
    <table class="w-full border text-sm mb-4">
      <thead class="bg-gray-100">
        <tr>
          <th class="border px-4 py-2 text-left w-16">SN</th>
    ...
    function renderTable() {
      ...
      pageItems.forEach((item, index) => {
        ...
        row.innerHTML = `
          ...
          <td class="border px-4 py-2 text-blue-600 underline cursor-pointer">PDF</td>
        `;
