...
<nav class="bg-white shadow-md fixed top-0 left-0 w-full z-10 ">
  ...
  <!-- Page Title -->
  <h1 class="text-3xl font-bold mb-6">President's Office</h1>
  ...
  <!-- Role Header Card -->
  <div class="flex items-center gap-4 text-sm text-gray-600 border-t border-b py-3 mb-6">
    <div class="flex items-center gap-2 text-orange-500 font-semibold">
      <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"><path d="M2.5 2.5v15l7.5-3.75L17.5 17.5v-15L10 6.25 2.5 2.5z" /></svg>
      University President
    </div>
    <span class="flex items-center gap-1"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M6 2a1 1 0 000 2h8a1 1 0 000-2H6zM3 6a1 1 0 011-1h12a1 1 0 011 1v11a1 1 0 01-1 1H4a1 1 0 01-1-1V6z" /></svg> 13 October 2020</span>
    <span class="flex items-center gap-1"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a8 8 0 100 16 8 8 0 000-16zM9 9V5a1 1 0 012 0v4H9zm0 4a1 1 0 012 0 1 1 0 11-2 0z" /></svg> Hits: 11943</span>
  </div>

  <!-- President Info -->
  <div class="mb-6">
    <h2 class="font-semibold text-lg">Professor Dr. Nooraddin Ismail Alla Werdi, University President</h2>
    <p class="text-sm mt-1">Telephone number: +964 66 2233444</p>
    <p class="text-sm">Email address: <a href="mailto:nooraddin.alla@hmu.edu.krd" class="text-blue-600 hover:underline">nooraddin.alla@hmu.edu.krd</a></p>
  </div>

  <!-- Responsibilities -->
  <div class="prose prose-sm text-justify text-gray-700">
    <p>The University President is responsible to oversee all activities and issues of the university and its colleges. Specific activities include:</p>
    <ul class="list-disc pl-6">
      <li>Maintain high level relations with other universities and related governmental ministries and directorates</li>
      <li>Report to the Ministry of Higher Education and Scientific Research and keep the communication well maintained</li>
      <li>Approve assignment and release of deans, assistant deans and heads of departments</li>
      <li>Approve recruitment of staff</li>
      <li>Supervise training and staff</li>
      <li>Supervise planning and follow up activities</li>
      <li>Oversee the quality assurance activities</li>
      <li>Exchange of correspondence with other universities and medical departments and organizations in the region or outside the region</li>
      <li>Head the University Council meetings</li>
      <li>Approve minutes of colleges’ council meetings</li>
      <li>Hold other admin and financial authorities delegated by the Ministry of Higher Education and Scientific Research</li>
      <li>Member of the Ministerial Council of the Higher Education and Scientific Research</li>
      <li>Patron of Zanco Journal of Medical Sciences, Erbil Dental Journal, and Erbil Journal of Nursing and Midwifery</li>
    </ul>
  </div>
</div>
